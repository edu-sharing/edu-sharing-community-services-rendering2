...
| Name                                       | Description                                  | Value                                                     |
| ------------------------------------------ | -------------------------------------------- | --------------------------------------------------------- |
| `nameOverride`                             | Override name                                | `edusharing-services-rendering2-document-converter`       |
| `image.name`                               | Set image name                               | `${docker.prefix}-deploy-docker-build-document-converter` |
