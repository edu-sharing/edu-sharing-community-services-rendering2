...
| Name                                       | Description                                                  | Value                                                 |
| ------------------------------------------ | ------------------------------------------------------------ | ----------------------------------------------------- |
| `nameOverride`                             | Override name                                                | `edusharing-services-rendering2-admin-frontend`       |
| `image.name`                               | Set image name                                               | `${docker.prefix}-deploy-docker-build-admin-frontend` |
...
| `ingress.annotations`                      | Set ingress annotations                                      | `{}`                                                  |
| `ingress.hosts`                            | Set ingress hosts                                            | `["rendering.services.127.0.0.1.nip.io"]`             |
| `ingress.tls`                              | Set TLS for ingress                                          | `[]`                                                  |
| `ingress.paths`                            | Set paths for ingress                                        | `["/rendering-admin"]`                                |
| `config.base`                              | Admin-API-Basis (Context-Path des Service) -> ADMIN_API_BASE | `/rendering`                                          |
| `config.uiBase`                            | Pfad, unter dem die UI ausgeliefert wird -> BASE_HREF        | `/rendering-admin`                                    |
...
| `terminationGracePeriod`                   | Define grace period for termination                          | `30`                                                  |
...
| `resources.limits.cpu`                     | Set CPU limit on resources                                   | `200m`                                                |
| `resources.limits.memory`                  | Set memory limit on resources                                | `128Mi`                                               |
| `resources.requests.cpu`                   | Set CPU for requests on resources                            | `50m`                                                 |
| `resources.requests.memory`                | Set memory for requests on resources                         | `64Mi`                                                |
